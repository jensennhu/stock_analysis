...
symbols <- c("ONDS","LPTH","DDD","IBRX","FIG","RIVN","RXRX","ACHR","NIO","OPEN","IONQ","INFQ","ZETA","HUMA","RDW","SPCX","EOSE","SMR","UUUU","FCX","VIX","IWM","COPX","GLD","QQQ","SPY","HOOD","CRCL","GLXY","CIFR","IREN","CRWV","COIN","CLSK","IBIT","WULF","CAN","ETHA","PLTR","ORCL","AAPL","NVDA","MSFT","GOOGL","AMZN","META","SIVEF","AAOI","SHOP","BTBT","SOXX","CMG","SPGI","CCLD","COST","RDDT","WYFI","XFAB","NET","QS","TSLA", "OUST","TSM")
...
imls_slides <- lapply(symbols, function(x) {
  knitr::knit_child(text = c('',
    ...
    '##### `r x` Static 2mo',
    '```{r, echo=FALSE, fig.width=8, fig.height=8, message=FALSE, warning = FALSE}',
    'plot_stock(x, data = stock_df, time = "last 6 month")',
    '```',
    '##### `r x` Static 1yr',
    '```{r, echo=FALSE, fig.width=8, fig.height=8, message=FALSE, warning = FALSE}',
    'plot_stock(x, data = stock_df, time = "last 2 year")',
    '```',
    ''
