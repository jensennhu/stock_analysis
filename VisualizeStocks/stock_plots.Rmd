...
# detail crosswalk
cx <- read.csv(here("Data", "nasdaq_screener.csv"))
```
...
symbols <- c("AAPL", "COST", "JPM", "GOOGL", "AMZN", "BGSAX", "NET", "VUG", "MSFT", "PRWCX", "NVDA", "DODGX", "PRGTX", "VOO", "VEIRX", "VTSAX", "BYDDY", "VWILX", "V", "VDADX", "QQQM", "QQQ", "VYM", "SCHD", "O", "TSM", "BABA", "VDE", "NBIS", "GELYF", "BA", "EL", "TCMD")
