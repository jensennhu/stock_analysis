...
symbols <- c("HOOD", "BBAI", "HIMS", "ONDS", "BULL", "MSTR", "BTBT", "ACHR", "TMC", "SPY",
             "UNH", "MSTY", "UTI", "TGT", "NET", "CHWY", "QBTS", "RGTI", "NFLX", "ON", "ULTY", "CMG","JOBY", "PANW","FIG", "HOVR",
             "AMD", "DIS", "SHOP", "IONQ", "RDDT")
